...
class Academicpart extends Component {
  ...
  render() {
    ...
    if (this.state.mining !== "") {
      mine = (
        <p data-aos="fade-in" data-aos-duration="500" data-aos-delay="500">
          Data mining : {this.state.mining}
        </p>
      );
    }
    if (this.state.back !== "") {
    ...
    return (
      <div data-aos="fade-in" className="academic-part">
        ...
        <div className="school-detail">
          <p>
            {this.state.school}, {this.state.location}
          </p>
          <p>{this.state.date}</p>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="500" className="aca-image">
          {this.state.image.map((item, i) => {
            if (
              item === "/static/media/ios2x.57d594e7.png" ||
              item === "/static/media/taiwanets.b5fb3a69.png"
            ) {
              return (
                <img
                  className="image-aca-mobile"
                  key={i}
                  alt={item}
                  src={item}
                />
              ...
              return (
                <img className="image-aca" key={i} alt={item} src={item} />
              );
            }
          })}
        </div>
