  ...
  render() {
    return(
      <div className='academic'>
        ...
        <Academicpart title='HeartTrade' intro='•	A platform that increases efficiency of trading daily necessities with users near around current location' school='COVID-19 Global Hackathon' location='Devpost	' date='Mar. 2020' image={[hearttrade]} content='The COVID-19 Global Hackathon is an opportunity for developers to build software solutions that drive social impact, with the aim of tackling some of the challenges related to the current coronavirus (COVID-19) pandemic. Contributions include but not limited to UI Design and Front-End development using React Hooks and Context API' git='https://github.com/Wesley16838/hackathon-COVID19' url='https://hearttrade.herokuapp.com/' front='React.js/ React Hooks/ Context API/ SCSS/ Gulp/ google-map-react' back='Node.js/ Express.js/ RESTful API/ MongoDB/ MongoDB Atlas/ Firebase' mining=''/>
...
' front='React.js/ Apollo/ SCSS/ Gulp/ d3.js' back='GraphQL/ MongoDB/ Atlas/ Heroku/ Firebase' mining='Python/ Selenium'/>
        ...
        <Academicpart title='Wesley Bookstore' intro='The bookstore using PHP implement basic features of online bookstore' school='Highline community college' location='Des Moines, WA' date='Winter 2018' image={[bookstore]} content='The bookstore is an academic project.  Using PHP connect to the 
