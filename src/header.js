          ...
          <div className="header-left-left">
            ...
            <div className="detail">
              ...
              <div className="btn-group">
                <a
                  href="https://github.com/Wesley16838/resume/blob/master/Resume2021.pdf"
                  target="_blank"
                ...
                <a
                  href="https://github.com/Wesley16838/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="basicBtn_reverse"
                >
                  GitHub
                </a>
              </div>
          ...
          <div data-aos="fade-in" data-aos-delay="500" data-aos-duration="1000">
            ...
            <picture>
              ...
              <source
                ...
                srcSet={me2}
              />
              <source media="(min-width: 1680px)" className="me" srcSet={me} />
              <img src={me} srcSet={me} className="me" alt="Me" />
            </picture>
          </div>
